...
use crate::{FeatureProcessor, PropertyProcessor};
use geo_types::*;
use std::mem;
...
impl PropertyProcessor for events::GeomVisitor<'_, GeoWriter> {}

impl FeatureProcessor for events::GeomVisitor<'_, GeoWriter> {}
...
mod test {
    ...
    fn geometry_collection() {
        ...
        let wkt = WktStr("GEOMETRYCOLLECTION (
    ...
    fn feature_collection() -> Result<()> {
        let geojson = r#"{"type": "FeatureCollection","name": "countries","features": [
